...
function getMonsterAttackValue(level){
    ...
    console.log(hit);
    return hit > 0 ? hit : 0; //ternuary operator; if hit is a negative value, it'll return 0. If we dont use this, the health will increase when the value is negative
}
